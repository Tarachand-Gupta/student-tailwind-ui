...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className="top-0 absolute fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg">
              ...
              <li className="flex items-center">
                <Link to="/auth/register" className="text-blueGray-200">
                  <button
                    ...
                    type="button"
                  >
                    <i className="fas fa-arrow-alt-circle-up"></i> SignUp
                </button>
